...
type User struct {
	...
	Pass     string `boil:"pass" json:"pass" toml:"pass" yaml:"pass"`
...
var UserWhere = struct {
	...
	Pass     whereHelperstring
}{
	ID:       whereHelperint{field: "\"users\".\"id\""},
	Name:     whereHelperstring{field: "\"users\".\"name\""},
	Username: whereHelperstring{field: "\"users\".\"username\""},
	Email:    whereHelperstring{field: "\"users\".\"email\""},
	Pass:     whereHelperstring{field: "\"users\".\"pass\""},
}
...
var (
	userAllColumns            = []string{"id", "name", "username", "email", "pass"}
	userColumnsWithoutDefault = []string{"name", "username", "email", "pass"}
